...
export const TableProducts: React.FC<TableProductsProps> = ({products, categorias, filteredCategory }) => {
    ...
    const handleNavigateToEdit = (idProd: number) => {
        if (Number(user?.role) === 1) {
            navigate(`/editar-produto/${idProd}`);
        } else {
            console.log("Acesso negado: apenas administradores podem editar produtos.");
        }
    }
                    ...
                    <TableHead>
                        <TableRow>
                            <ProtectedComponent allowedRoles={['1', '2']}>
                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "12px", padding: "10px" } }}>Código</TableCell>
                            </ProtectedComponent>
                            <ProtectedComponent allowedRoles={['1', '2']}>
                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "12px", padding: "10px" } }}>Nome</TableCell>
                            </ProtectedComponent>
                            <ProtectedComponent allowedRoles={['1', '2']}>
                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "12px", padding: "10px" } }}>Categoria</TableCell>
                            </ProtectedComponent>
                            <ProtectedComponent allowedRoles={['1', '2']}>
                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "12px", padding: "10px" } }}>Estoque</TableCell>
                            </ProtectedComponent>
                            <ProtectedComponent allowedRoles={['1']}>
                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "12px", padding: "10px" } }}>Preço de Custo</TableCell>
                            </ProtectedComponent>  
                            <ProtectedComponent allowedRoles={['1']}>
                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "12px", padding: "10px" } }}>Porcentagem de Lucro</TableCell>
                            </ProtectedComponent>
                                <ProtectedComponent allowedRoles={['1', '2']}>
                            <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "12px", padding: "10px" } }}>Preço de Venda</TableCell>
                                </ProtectedComponent>
                            <ProtectedComponent allowedRoles={['1']}>
                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "12px", padding: "10px" } }}>Remover</TableCell>
                            </ProtectedComponent>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                            ...
                            filteredProducts.length === 0 ? (
                                ...
                                filteredProducts.sort((a, b) => b.Prod_Categoria - a.Prod_Categoria).slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(product => (
                                        <TableRow key={product.ID_Prod} hover sx={{ cursor: 'pointer' }} onClick={() => handleNavigateToEdit(product.ID_Prod)}>
                                            ...
                                            <ProtectedComponent allowedRoles={['1', '2']}>
                                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "11px", padding: "10px" } }}>{product.Prod_Nome}</TableCell>
                                            </ProtectedComponent>
                                            <ProtectedComponent allowedRoles={['1', '2']}>
                                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "11px", padding: "10px" } }}>{product.Prod_Categoria ? categorias?.find(c => c.ID_CategoriaProduto === product.Prod_Categoria)?.CatProd_Nome : "Sem categoria"}</TableCell>
                                            </ProtectedComponent>
                                            <ProtectedComponent allowedRoles={['1', '2']}>
                                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "11px", padding: "10px" } }}>{product.Prod_Estoque}</TableCell>
                                            </ProtectedComponent>
                                            <ProtectedComponent allowedRoles={['1']}>
                                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "11px", padding: "10px" } }}>R${product.Prod_CustoCompra}</TableCell>
                                            </ProtectedComponent>
                                            <ProtectedComponent allowedRoles={['1']}>
                                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "11px", padding: "10px" } }}>{product.Prod_PorcLucro}%</TableCell>
                                            </ProtectedComponent>
                                            <ProtectedComponent allowedRoles={['1', '2']}>
                                                <TableCell sx={{ fontSize: 14, textAlign: "center", '@media (max-width: 800px)': { fontSize: "11px", padding: "10px" } }}>R${product.Prod_Valor}</TableCell>
                                            </ProtectedComponent>
                                            <ProtectedComponent allowedRoles={['1']}>

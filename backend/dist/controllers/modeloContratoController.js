...
export const getModelosContrato = async (req, res) => {
    try {
...
export const getModeloContratoById = async (req, res) => {
    try {
...
export const createModeloContrato = async (req, res) => {
    try {
...
export const deleteModeloContrato = async (req, res) => {
    try {
        const id = Number(req.params.id);
...
//# sourceMappingURL=modeloContratoController.js.map
...
export const getModelContractItensById = async (req, res) => {
    try {
...
export const createModelContractItem = async (req, res) => {
    try {
...
export const deleteModelContractItem = async (req, res) => {
    try {
        const id = Number(req.params.id);
...
export const updateModelContractItem = async (req, res) => {
    try {
        const id = Number(req.params.id);
...
//# sourceMappingURL=modeloContratoItensController.js.map